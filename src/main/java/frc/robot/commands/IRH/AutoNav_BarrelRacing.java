...
public class AutoNav_BarrelRacing extends SequentialCommandGroup {
  ...
  public AutoNav_BarrelRacing() {
    ...
    addCommands(new AutoMoveFoward(75), new Square(60, 90), new AutoMoveFoward(90), new Square(60, -90), new AutoMoveFoward(60), new Square(60, 90), new Turn(180), new AutoMoveFoward(225));
  }
}
